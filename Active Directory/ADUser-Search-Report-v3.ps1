...
Description: Search AD users based on you search term and export a report of the results.
==============================================================================================================================
...
Get-ADUser -Filter {name -like "*<YourSearchTerm>*"} -Properties SamAccountName | Select-Object Name | Sort-Object Name | Export-Csv -Path "C:\scriptsOutput\AD_User_Search_$label.csv" -NoTypeInformation -Append

}

# Display a message that searching has finished
Write-Output "Search completed. Report exported to C:\scriptsOutput\AD_User_Search_$label.csv" | Out-Host
