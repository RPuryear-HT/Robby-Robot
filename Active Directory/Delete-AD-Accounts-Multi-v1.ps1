...
==============================================================================================================================
Note: Must have a user list located at C:\scripts\deletes.txt. WILL prompt to confirm each user before performing deletions. 
Use my other deletion script to skip confirmations. The text file and any variables used are purged at script completion to 
avoid any conflicts or unnecessary data retention. Backup your user list as needed, before executing. Use at your own risk.
==============================================================================================================================
...
$runtime = Measure-Command {
    ...
    foreach ($username in $usernames) {
        ...
        # Remove the user from Active Directory with confirmation
